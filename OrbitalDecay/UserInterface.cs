...
namespace WhitecatIndustries.Source
{
    ...
    internal class UserInterface : MonoBehaviour
    {
        ...
        public static Vector3d NBodyMomentaryDeltaV = new Vector3d();
        ...
        public void MainWindow(int windowID)
        {
            ...
            if (GUI.Button(new Rect(MainwindowPosition.width - 22, 3, 18, 18), "x"))
            {
                ToolbarInterface.GuiOff();
        ...
        {
            GUILayout.BeginHorizontal();
            GUILayout.Label("Vessel Information", centeredBigLabel, GUILayout.Width(290));
            GUILayout.EndHorizontal();
            ...
            if (GUILayout.Button(GameDatabase.Instance.GetTexture("WhitecatIndustries/OrbitalDecay/Icon/Icon_Unmanned", false)))
            {
            ...
            GUILayout.Space(3);
            if (GUILayout.Button(GameDatabase.Instance.GetTexture("WhitecatIndustries/OrbitalDecay/Icon/Icon_Relay", false)))
            {
            ...
            if (GUILayout.Button(GameDatabase.Instance.GetTexture("WhitecatIndustries/OrbitalDecay/Icon/Icon_Ship", false)))
            {
            ...
            if (GUILayout.Button(GameDatabase.Instance.GetTexture("WhitecatIndustries/OrbitalDecay/Icon/Icon_Station", false)))
            {
            ...
            if (GUILayout.Button(GameDatabase.Instance.GetTexture("WhitecatIndustries/OrbitalDecay/Icon/Icon_Spaceobject", false)))
            {
            ...
            if (GUILayout.Button(GameDatabase.Instance.GetTexture("WhitecatIndustries/OrbitalDecay/Icon/Icon_Debris", false)))
            {
        ...
        public void SettingsTab()
        {
            ...
            GUILayout.BeginHorizontal();
            GUILayout.Label("Control Panel", centeredBigLabel, GUILayout.Width(290));
            GUILayout.EndHorizontal();
           ...
           bool NBody = Settings.ReadNB();
            ...
            GUILayout.Space(2);
            GUILayout.Label("Current Decay multiplier: " + DecayDifficulty.ToString("F1"), centeredLabel);
            GUILayout.Space(2);
            GUILayout.Label("New Decay multiplier: " + (MultiplierValue / 5).ToString("F1"), centeredLabel);
            GUILayout.Space(2);
            ...
            GUILayout.Space(2);
            GUILayout.Label("_________________________________________", centeredLabel);
            GUILayout.Space(3);
            MultiplierValue2 = GUILayout.HorizontalSlider(MultiplierValue2, 0.5f, 50.0f);
            GUILayout.Space(2);
            GUILayout.Label("Resource drain rate multiplier: " + ResourceDifficulty.ToString("F1"), centeredLabel);
            GUILayout.Space(2);
            GUILayout.Label("New Resource drain rate multiplier: " + (MultiplierValue2 / 5).ToString("F1"), centeredLabel);
            GUILayout.Space(2);
        ...
        */
        ...
        public void DecayBreakdownWindow(int id)
        {
            ...
            if (GUI.Button(new Rect(DecayBreakdownwindowPosition.width - 22, 3, 18, 18), "x"))
            {
                if (ToolbarInterface.DecayBreakdownVisible)
